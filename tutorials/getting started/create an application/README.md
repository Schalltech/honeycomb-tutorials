...
#### Step 1: Login
To get started, log in to your Honeycomb Studio account. If you have not created an account, you will need to do so before continuing to the next step.

https://microapp.studio
...
Styles defined within the container property will be applied to the container surrounding the micro app. Any valid css value can be specified as long as it is entered in camel case (ex: alignItems vs align-items). 
...
Your application should now be displayed within a new browser window! While hosted on the cloud, your application is accessible to anyone that has the url to your application. Applications hosted on the cloud are available from the https://microapp.host/[your-account]/[application-name].
